...
slate.downloadJson = function(){
    var data = {people:buildPeople.people,matches:slate.matches,lockins:slate.lockins,mustFills:slate.mustFills,commandReqs:slate.commandReqs,commandOrder:slate.commandOrder};
